      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        <div className="mb-8 border-2 border-dashed border-primary bg-card/50 p-6">
          ...
          <p className="text-muted-foreground font-mono text-xs tracking-wide">
            Search and view transactions on the Seloria network
          </p>
        </div>

        <TerminalBox title="TRANSACTION LOOKUP">
          ...
          <div className="text-muted-foreground mt-8 border-t border-border/50 pt-6 font-mono text-[10px] tracking-wider">
            ...
            <ul className="space-y-1 pl-4">
              <li>• Enter the full transaction hash (64 hex characters)</li>
              <li>• Transactions are indexed from finalized blocks</li>
              <li>• Pending transactions are in the mempool</li>
            </ul>
          </div>
        </TerminalBox>

        <div className="mt-8">
          <TerminalBox title="RECENT ACTIVITY" subtitle="Coming soon">
